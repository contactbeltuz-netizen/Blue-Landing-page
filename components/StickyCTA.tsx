...
const StickyCTA: React.FC = () => {
  ...
  return (
    <div className="fixed right-4 md:right-8 bottom-8 z-[150] flex flex-col gap-4 items-end pointer-events-none">
      {/* Background Glows for the group - moved to bottom corner */}
      <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#ff6c00]/10 blur-[60px] pointer-events-none rounded-full"></div>

      {/* Quick Access Info Badge - positioned above buttons now */}
      <div className="mb-2 mr-2 flex flex-col items-end gap-1 opacity-0 group-hover:opacity-100 transition-all duration-700 pointer-events-none lg:flex">
